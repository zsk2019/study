...
public:
  Component(string _name) : m_strComponent(_name) {}
  virtual ~Component() {}
  virtual void Operation() = 0;
  virtual void Add(Component *com) = 0;
  virtual void Remove(Component *com) = 0;
  virtual Component *Getchild(int index) = 0;
  virtual string getName() { return m_strComponent; }
...
public:
  ...
  void Operation() { cout << "name : " << m_strComponent << endl; }
...
public:
  ...
  void Operation() { cout << "我是 " << m_strComponent << endl; }
  void Add(Component *com) { m_vecComp.push_back(com); }

  void Remove(Component *com) {
    for (vector<Component *>::iterator it = m_vecComp.begin();
         it != m_vecComp.end(); ++it) {
